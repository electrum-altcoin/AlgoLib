...
cdef extern from "cryptonight/cryptonight.h":
	extern void cryptonight_hash(const char* input, char* output, uint32_t input_len);
...
cdef extern from "yescrypt/yescrypt.h":
